...
- Test resizeMedia() for Append Element mode and uncomment out the code if it works well enough (requires testing a lot of URLs)
...
- Change Screenshot 3 (Append)'s Media screen grabs
